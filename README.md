...
7. Create `shopify.app.toml` file in the root directory copied from [this page](https://shopify.dev/docs/apps/tools/cli/configuration) and replace each value as follows.
...
- [Checkout UI Extension Integration Deep Dive](../../wiki/Checkout-UI-Extension-Integration-Deep-Dive) ([Japanese version](../../wiki/Checkout-UI-Extension-実装詳細))help you to understand how the extension work deeply and avoid some pitfalls.
