...
// Read https://shopify.dev/docs/api/checkout-ui-extensions/latest/targets/address/purchase-address-autocomplete-suggest

/** @param {import('@shopify/ui-extensions/purchase.address-autocomplete.suggest').Api} api */
export default async ({signal, target}) => {
