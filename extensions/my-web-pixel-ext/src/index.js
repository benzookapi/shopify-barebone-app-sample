...
register(async ({ analytics, browser, settings, init }) => {
  // Read https://shopify.dev/api/pixels/pixel-extension#app-web-pixels
  ...
  // Read https://shopify.dev/api/pixels/customer-events
  analytics.subscribe('all_events', (event) => {
    ...
    // Read https://developer.mozilla.org/en-US/docs/Glossary/CORS
    ...
    // Read https://developers.google.com/analytics/devguides/collection/protocol/ga4/validating-events?client_type=gtag
    ...
    // Read https://shopify.dev/api/pixels/customer-events#checkout_started
    // Read https://shopify.dev/docs/api/pixels/customer-events#payment_info_submitted
    // Read https://shopify.dev/docs/api/pixels/customer-events#checkout_completed

    // Send event data to GA4
    // Read https://developers.google.com/analytics/devguides/collection/ga4/ecommerce?client_type=gtag
    // Read https://developers.google.com/analytics/devguides/collection/protocol/ga4/sending-events?hl=ja&client_type=gtag
