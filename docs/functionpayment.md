...
- The app server creates the payment customization through Admin GraphQL.
...
sequenceDiagram
    ...
    participant App as /functionpayment.json
    ...
    App->>AdminAPI: paymentCustomizationCreate with JSON metafield
...
- [`app/pages/FunctionPayment.jsx`](../app/pages/FunctionPayment.jsx): settings UI
- [`app/routes/functionpayment-json.jsx`](../app/routes/functionpayment-json.jsx): authenticated endpoint
- [`app/lib/functions-samples.server.js`](../app/lib/functions-samples.server.js): `paymentCustomizationCreate` mutation
