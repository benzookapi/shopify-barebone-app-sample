...
- The app server creates a delivery customization through Admin GraphQL.
...
sequenceDiagram
    ...
    participant App as /functionshipping.json
    ...
    App->>AdminAPI: deliveryCustomizationCreate with JSON metafield
    AdminAPI-->>UI: Customization result
...
- [`app/pages/FunctionShipping.jsx`](../app/pages/FunctionShipping.jsx): configuration UI
- [`app/routes/functionshipping-json.jsx`](../app/routes/functionshipping-json.jsx): authenticated endpoint
- [`app/lib/functions-samples.server.js`](../app/lib/functions-samples.server.js): `deliveryCustomizationCreate` mutation
