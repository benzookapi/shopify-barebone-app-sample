...
function CheckoutUi() {
  ...
  return (
    <Page title="Checkout UI sample for upselling / store review / IP address blocking, and chekcout branding">
            ...
            <List type="number">
              <List.Item>
                <p>
                  ...
                  }}>Post-purchase sample</Link> to <b>register all used metafields and set the values following the step 1</b>.
                </p>
              </List.Item>
              <List.Item>
                <p>
      ...
      <Card title="Step 2: Try your checkout UI extensions" sectioned={true}>
        <Layout>
          ...
          <Layout.Section>
            <p>
              <b>TIPS: </b>This extension uses extension provided <Link url="https://shopify.dev/docs/api/checkout-ui-extensions/configuration#api-access" external={true}>Storefront API calls</Link> and its own <Link url="https://shopify.dev/docs/api/checkout-ui-extensions/configuration#network-access" external={true}>server side access</Link> shared with <Link onClick={() => {
                redirect.dispatch(Redirect.Action.APP, '/postpurchase');
              }}>Post-purchase sample</Link> wtih extension privided <Link url="https://shopify.dev/docs/api/checkout-ui-extensions/apis/standardapi#properties-propertydetail-sessiontoken" external={true}>session tokens</Link>.
            </p>
          </Layout.Section>
        </Layout>
      </Card>
      <Card title="Step 3: Customize your checkout branding with API" sectioned={true}>
        <Layout>
          <Layout.Section>
            <Link url="https://shopify.dev/docs/apps/checkout/advanced-checkout-branding" external={true}>Dev. doc</Link>
          </Layout.Section>
          <Layout.Section>
            <List type="number">
              <List.Item>
